...
### Creating Armor <v-chip color="secondary" text-color="white" class="v-chip--x-small">new</v-chip>
...
Armor mods have their own costs. Operatives who are proficient with Tinker's tools can craft armor mods but most can be
purchased from your local armor shop. Once you've acquired your armor mod, you can install it yourself (if you're
proficient with Armorsmith's or Tailor's tools) or you can have an armor shop install it for you. In general, armor mods
cannot be removed. Those proficient with Armorsmith's or Tailor's may attempt to salvage mods ad the risk of destroying the
armor piece. Armor shops around the galaxy typically won't offer this service for fear of a lawsuit.
