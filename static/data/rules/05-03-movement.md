...
particularly a large station or a asteroid colony, the GM can summarize movement between encounters: "After subduing the
...
More details about travelling in transports and starships is provided in the <nuxt-link to="/phb/rules/vehicles">vehicles</nuxt-link> section.
...
While climbing or swimming, each meter of movement costs 1 extra meter (2 extra meter in difficult terrain), unless a
