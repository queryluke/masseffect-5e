...
tank. You can either spend a long rest on an asteroid or planet mining fuel or you can refuel at a space port. Mining
fuel requires a Intelligence (Investigation) check with your ship's SSC. The DC of this check is determined by how "rich"
the asteroid is with elements needed to create fuel. The GM can determine this DC. On a success, roll a d8 an regain
that many charges for your tank. _Note_: GMs can use this same technique if they whish to employ mining and resource
gathering for other valuable materials and minerals.
