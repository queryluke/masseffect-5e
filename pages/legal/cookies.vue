<template>
  <v-container>
    <h2>Cookie Policy</h2>
    <p>We use cookies to help improve your experience of our website at <a href="https://n7.world">https://n7.world</a>. This cookie policy is part of N7 World&#39;s privacy policy. It covers the use of cookies between your device and our site. </p>
    ...
    <p>If you don’t wish to accept cookies from us, you should instruct your browser to refuse cookies from <a href="https://n7.world">https://n7.world</a>. In such a case, we may be unable to provide you with some of your desired content and services. </p>
...
export default {
  head () {
    return {
      title: 'Cookie Policy | Mass Effect 5e'
    }
  },
  created () {
    this.$store.commit('pageTitle', 'Cookie Policy')
  }
}
</script>
