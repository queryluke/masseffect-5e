<template>
  <v-container>
    ...
    <p>Your privacy is important to us. It is N7 World&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://n7.world">https://n7.world</a>, and other sites we own and operate. </p>
    ...
    <p>This policy is effective as of 20 December 2021. </p>
    <p>Last updated: 20 December 2021 </p>
    ...
    <p>The GDPR distinguishes between organisations that process personal information for their own purposes (known as &ldquo;data controllers&rdquo;) and organizations that process personal information on behalf of other organizations (known as &ldquo;data processors&rdquo;). We, N7 World, located at the address provided in our Contact Us section, are a Data Controller and/or Processor with respect to the personal information you provide to us. </p>
...
export default {
  head () {
    return {
      title: 'Privacy Policy | Mass Effect 5e'
    }
  },
  created () {
    this.$store.commit('pageTitle', 'Privacy Policy')
  }
}
</script>
