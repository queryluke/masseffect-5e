<template>
  <v-container>
    ...
    <p>This acceptable use policy covers the products, services, and technologies (collectively referred to as the &ldquo;Products&rdquo;) provided by N7 World under any ongoing agreement. It’s designed to protect us, our customers, and the general Internet community from unethical, irresponsible, and illegal activity. </p>
    <p>N7 World customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities. </p>
    <p>This policy was last reviewed on 20 December 2021. </p>
    <h3>Fair use</h3>
    ...
    <h4>Unauthorized use of N7 World property</h4>
    <p>We prohibit the impersonation of N7 World, the representation of a significant business relationship with N7 World, or ownership of any N7 World property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage, or user trust. </p>
...
export default {
  head () {
    return {
      title: 'Acceptable Use Policy | Mass Effect 5e'
    }
  },
  created () {
    this.$store.commit('pageTitle', 'Acceptable Use Policy')
  }
}
</script>
