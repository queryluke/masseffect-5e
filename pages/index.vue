        ...
        <v-row justify="center">
          ...
          >
            ...
            <h2 class="black--text text-h6 mt-10">
              {{ $t('site.homepage.title') }}
            </h2>
            <p class="black--text text-subtitle-2">
              {{ $t('site.homepage.subtitle') }}
            </p>
            <v-btn to="/manual/intro" large color="secondary" class="my-3">
              {{ $t('site.homepage.get_started') }}
            </v-btn>
          </v-col>
        </v-row>
      </v-parallax>
      ...
      <v-container>
        <v-row justify="center" class="mt-5">
          <v-col cols="12" sm="10" md="8" class="my-3 text-center">
            <h3 class="text-h6">
              {{ $t('site.homepage.begin') }}
            </h3>
            <p>
              {{ $t('site.homepage.begin_text') }}
            </p>
          </v-col>
        </v-row>
        <v-row justify="center" class="mt-5">
          <v-col cols="12" md="4">
            <v-card elevation="0" class="transparent">
              ...
              <v-card-title class="layout justify-center">
                {{ $t('site.homepage.info[0].title') }}
              </v-card-title>
              <v-card-text>
                {{ $t('site.homepage.info[0].text') }}
              </v-card-text>
            </v-card>
          </v-col>
          <v-col cols="12" md="4">
            <v-card elevation="0" class="transparent">
              ...
              <v-card-title class="layout justify-center">
                {{ $t('site.homepage.info[1].title') }}
              </v-card-title>
              <v-card-text>
                {{ $t('site.homepage.info[1].text') }}
              </v-card-text>
            </v-card>
          </v-col>
          <v-col cols="12" md="4">
            <v-card elevation="0" class="transparent">
              ...
              <v-card-title class="layout justify-center">
                {{ $t('site.homepage.info[2].title') }}
              </v-card-title>
              <v-card-text>
                {{ $t('site.homepage.info[2].text') }}
              </v-card-text>
            </v-card>
          </v-col>
        </v-row>
          ...
          <v-col cols="12" class="my-3">
            <v-card elevation="0" class="transparent">
              <div class="d-flex flex-no-wrap justify-space-between">
                <div>
                  <v-card-title>
                    {{ $t('site.homepage.features[0].title') }}
                  </v-card-title>
                  <v-card-text>
                    {{ $t('site.homepage.features[0].text') }}
                  </v-card-text>
                  <v-card-actions>
                    <v-btn to="/manual/intro" text>
                      {{ $t('site.homepage.features[0].button') }} <v-icon>mdi-chevron-right</v-icon>
                    </v-btn>
                  </v-card-actions>
                </div>
                <v-avatar
          ...
          <v-col cols="12" class="my-3">
            <v-card elevation="0" class="transparent">
              <div class="d-flex flex-no-wrap justify-space-between">
                ...
                <div>
                  <v-card-title>
                    {{ $t('site.homepage.features[1].title') }}
                  </v-card-title>
                  <v-card-text>
                    {{ $t('site.homepage.features[1].text') }}
                  </v-card-text>
                  <v-card-actions>
                    <v-btn to="/assets" text>
                      {{ $t('site.homepage.features[1].button') }} <v-icon>mdi-chevron-right</v-icon>
                    </v-btn>
                  </v-card-actions>
                </div>
              </div>
          ...
          <v-col cols="12" class="my-3">
            <v-card elevation="0" class="transparent">
              <div class="d-flex flex-no-wrap justify-space-between">
                <div>
                  <v-card-title>
                    {{ $t('site.homepage.features[2].title') }}
                  </v-card-title>
                  <v-card-text>
                    {{ $t('site.homepage.features[2].text') }}
                  </v-card-text>
                  <v-card-actions>
                    <v-btn to="/about" text>
                      {{ $t('site.homepage.features[2].button') }} <v-icon>mdi-chevron-right</v-icon>
                    </v-btn>
                  </v-card-actions>
                </div>
                <v-avatar
