...
* Piercing Mod: Rename piercing ammo. Has same toggleable as other ammo mods. Ignores 2 AC if target is behind cover.
* Shredder mod: Rename shredder ammo. Has same toggleable as other ammo mods. Changed damage type to slashing. An unprotected, organic creature that is hit by this weapon looses 2d4 hit points at the start of it's next turn due to bleeding.
