<template lang="jade">
  div
    h2 General
    p.
      Overall, this system attempts to keep things as in line with D&D 5e rules as much as possible. Some system
    ...
    rule-card
      ...
      template(slot="text")
        ...
        p.
          ...
          many shield points. Some armor modifications and abilities can allow this to happen everyturn. Other mods and
        ...
        p.headline.mt-2 Lightning Damamge
        p.
          Shields are vulnerable to lightning damamge. In the event that a shield gains resistence to lightning damage,
    ...
    rule-card
      ...
      template(slot="text")
        p.
          These are special proficiency bonuses that can be applied to certain skill checks. For example, you might try
        ...
        p.
          Paragon and Renegade is earned as you play. It can be rewarded by the GM based on actions you take during the campaign.
    ...
    rule-card
      ...
      template(slot="text")
        p.
          Since AIs and Reapers exist in Mass Effect, there are 3 types of creatures: Organic, Synthetic, and Synthorganic.
          Some abilities only effect organic or synthetic creatures, as notated in the ability text. Synthorganic creatures
          are considered both synthetic and organic.
    rule-card
      span(slot="header") Distance
      template(slot="text")
        p.
          I use meters instead of feet. Why? Because this is set in the future and it's sci-fi and using metric just seems to
          make more sense. The general rule of thumb is that 5ft = 2m. Or, if you're using a playmat, 2m = 1 space.
    rule-card
      span(slot="header") Sexy Level
      template(slot="text")
        p.
