<template lang="pug">
  rule-card
    span(slot="header") Spell Save DC
    template(slot="text")
      p.
        We still use the term Spell Save DC to refer to any saving throw DC that is prompted by an ability not just biotic spells.
      p.
