    ...
    template(slot="text")
      ul.pl-3
        ...
        li.
          ...
          a player cannot salvage a mechanic from an armor set and use it as a mod...well, unless you allow it as the GM.
      div.hr
      ...
      v-alert(type="info" v-bind:value="true").mt-2.
        #[strong GM Note]: When creating Armor Sets, the cost is still a rule of thumb. If an Armor Set seems to expensive or cheap,
