    ...
    recharge () {
      if (this.feature.uses) {
        if (this.feature.perDay) {
          return this.$t('uses_per_day', { amount: this.feature.uses })
        }
        if (this.feature.perTurn) {
          return this.$t('uses_per_turn', { amount: this.feature.uses })
        }
        return this.$t('uses', { amount: this.feature.uses })
      }
      if (this.feature.recharge) {
        if (this.feature.recharge === 'short') {
          return this.$t('rest_recharge.short')
        }
        if (this.feature.recharge === 'long') {
          return this.$t('rest_recharge.long')
        }
