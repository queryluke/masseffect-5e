  ...
  rule-card(id="weapon-customization")
    ...
    template(slot="text")
      ...
      ul
        ...
        li.
          #[strong Melee] weapons break the mold because all weapon mods are based on guns. However, melee weapon attacks can be bolstered by
          utilizing armor mods instead.
      p.title.mt-3 Customizing a Weapon
      p.
        Each customizable weapon has 4 mod slots: Magazine, Body, Core, and Barrel. The weapon is only allowed one mod per slot.
        For example, the M-8 Avenger cannot have the Ultralight Materials #[em and] the Precision Scope, because both of those mods
        utilize the Body slot. But, weapons mods can be replaced. In this example, the player could choose to replace
        Ultralight Materials for the Precision Scope.
      p.
        Additionally, some mods can only be added to a specific weapon type. For example, the Stunner mod is only available for
        placement on Heavy Pistols and SMGs.
      v-btn(to="/phb/weapon-mods") Mod List
      div.hr
      p.title Mod Persistence
      p.
        Our intention with the weapon mod system is to add ways for players to create improved versions of their weapons.
        I.e., it's a way of getting +1 versions of a weapon you already own. In 5th Edition, players would need to loot or
        purchase an entirely new weapon. Therefore, we do not believe mods should be persistent. A player who has already
        purchased a Thermal Scope cannot move that Thermal Scope from one weapon to another.
      p.
