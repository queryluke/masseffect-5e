export const state = () => ({
  ...
  companionTabs: ['Name & Image', 'Abilities & Skills', 'Defenses', 'Speed & Senses', 'Actions', 'Relevant Class Features'],
  actionsTabs: ['All', 'Attacks', 'Actions', 'Bonus Actions', 'Reactions', 'Other', 'Companion'],
  actionsTab: 0,
...
export const getters = {
  ...
  companionTab: state => state.companionTab,
